...
public class SentimentAnalysisWithInterface {

    public static void main(String[] args) throws Exception {

        SentimentAnalysisWithInterface sentimentAnalysisWithInterface = new SentimentAnalysisWithInterface();
        sentimentAnalysisWithInterface.run(args);
    ...
    private void run(String[] args) throws IOException {
        ...
        IAnalysis analysis = new AnalysisImpl();
        analysis.analyseSentiment(args, wordToSentinents);
    }
    ...
    public interface IAnalysis {
        public void analyseSentiment(String[] args, Map<String, String> wordToSentinents);
    }
